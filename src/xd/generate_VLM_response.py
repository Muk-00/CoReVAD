...
if __name__ == "__main__":
    save_name="VLM_responses_xd"
    mllm_path = 'OpenGVLab/InternVL2-8B'
    device = torch.device('cuda:0')
    video_dir = "/path/to/XD-Violence/test/"
    test_path = "/path/to/XD-Violence/xd_annotations.json"

    prompt_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "P_VLM_format.txt"))
